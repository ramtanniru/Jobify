                ...
                <div className='shadow rounded-3 d-flex flex-row p-5 text-start align-items-center mt-5 bg-white'>
                    <div className='d-flex flex-column col-9'>
                        ...
                        <form className='d-flex flex-wrap gap-3 align-items-end'>
                            ...
                            <div className='col-5'>
                                <label className='form-label' for='mode'>Job mode</label>
                                <input id='mode' className='form-control'/>
                            </div>
                            <div className='col-5'>
                                <label className='form-label' for='salary'>Salary</label>
                                <input id='salary' className='form-control'/>
                            </div>
                            <div className='col-5'>
                                <label className='form-label' for='skills'>Skills</label>
                                <input id='skills' className='form-control'/>
                            </div>
                            <div className='col-9'>
                                <label className='form-label' for='description'>Job description</label>
                                <textarea id='description' className='form-control'></textarea>
                            </div>
                            <div className='rounded-5 bg-primary d-flex align-items-center justify-content-center' style={{height:'60px', width:'60px'}}>    
